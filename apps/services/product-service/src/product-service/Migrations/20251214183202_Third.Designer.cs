...
namespace productservice.Migrations
{
    ...
    [Migration("20251214183202_Third")]
    partial class Third
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ProductVariantVariantOptionValue", b =>
                {
                    b.Property<Guid>("ProductVariantsId")
                        .HasColumnType("uuid");

                    b.Property<Guid>("VariantOptionValuesId")
                        .HasColumnType("uuid");

                    b.HasKey("ProductVariantsId", "VariantOptionValuesId");

                    b.HasIndex("VariantOptionValuesId");

                    b.ToTable("ProductVariantVariantOptionValue");
                });
            ...
            modelBuilder.Entity("ProductVariantVariantOptionValue", b =>
                {
                    ...
                    b.HasOne("Models.VariantOptionValue", null)
                        .WithMany()
                        .HasForeignKey("VariantOptionValuesId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
